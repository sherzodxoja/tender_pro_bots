...
config :bots, :bots_spec, [
	{"worker_bot", :active, [{:token, "182601977:AAH3HkVAeHBQfuFH_GrIh_qEKfgPmybhliU"}, {:commander, TenderProBots.Commanders.Telegram.Commander}]}
	#{"webhook_bot", :passive, [{:token, "182601977:AAH3HkVAeHBQfuFH_GrIh_qEKfgPmybhliU"}, {:commander, TenderProBots.Commanders.Telegram.Commander}]}
]
